...
if __name__ == '__main__':
    ...
    search_keys = ['department faculty']
    ...
    for university in universities:
        ...
        page = page.Page(university_url, university_id)
        for department in departments:
            for search_key in search_keys:
                ...
                for result_object in search_results:
                    page.crawl_node(result_object.url, 0) #currently scrape depth 0, only surface
                    professor_list = page.output_professors()
